...
public class GuessColorViewModelTest {
    ...
    public void placeBet_realMode_redTag_buildsCorrectMemoAndUpdatesBalance() throws InterruptedException {
        ...
        stubBalance("500");
        when(repository.sendPayment(eq(NetworkConfig.SERVER_ROULETTE), eq("RLT:r@50:ref"), eq(new BigDecimal("50"))))
                .thenReturn(true);
        ...
        assertEquals("50", awaitValue(viewModel.getBetSuccess()));
        verify(repository).sendPayment(NetworkConfig.SERVER_ROULETTE, "RLT:r@50:ref", new BigDecimal("50"));
    ...
    public void placeBet_realMode_blackTag_buildsCorrectMemo() throws InterruptedException {
        MainActivity.IS_REAL_GAME_MODE = true;
        stubBalance("500");
        when(repository.sendPayment(eq(NetworkConfig.SERVER_ROULETTE), eq("RLT:b@50:ref"), eq(new BigDecimal("50"))))
                .thenReturn(true);
        when(repository.getBalance()).thenReturn(new BigDecimal("450"));
        ...
        assertEquals("50", awaitValue(viewModel.getBetSuccess()));
        verify(repository).sendPayment(NetworkConfig.SERVER_ROULETTE, "RLT:b@50:ref", new BigDecimal("50"));
    }
