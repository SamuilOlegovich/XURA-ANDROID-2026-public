...
public class GuessNumberViewModelTest {
    ...
    public void placeBet_realMode_validBet_sendsPaymentWithNumberMemo() throws InterruptedException {
        ...
        stubBalance("500");
        when(repository.sendPayment(eq(NetworkConfig.SERVER_NUMBER), eq("BET:N:17:ref"), eq(new BigDecimal("50"))))
                .thenReturn(true);
        ...
        assertEquals("50", awaitValue(viewModel.getBetSuccess()));
        verify(repository).sendPayment(NetworkConfig.SERVER_NUMBER, "BET:N:17:ref", new BigDecimal("50"));
