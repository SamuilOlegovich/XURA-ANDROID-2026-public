...
public class WalletRepository {
    ...
    /** Возвращает реальный спендабельный баланс кошелька (с вычетом резерва) независимо от режима игры.
     *  Используется экраном отправки — кошелёк отправляет реальные XRP всегда. */
